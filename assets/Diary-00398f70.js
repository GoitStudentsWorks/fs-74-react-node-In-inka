...
`,E=({display:i})=>e.jsx("div",{style:{display:i,justifyContent:"center",width:"100%"},children:e.jsx(Q,{strokeColor:"grey",strokeWidth:"5",animationDuration:"0.75",width:"20%",visible:!0})}),W=n.svg`
  &.orange {
...
`;function ki(i){let t=i.getDate(),r=i.getMonth()+1;const a=i.getFullYear();return t=t<10?`0${t}`:t,r=r<10?`0${r}`:r,`${t}/${r}/${a}`}const $i=()=>{R.warn("the date must be greater than your birthday",{theme:"dark"})},Oi=()=>{const i=localStorage.getItem("PowerPulsDate"),t=i?new Date(i):new Date,[r,a]=C.useState(t),s=$(),d=p(u.getDiary),{eatenProducts:c,doneExercises:h}=d,o=new Date(p(k.getUserMetricData).birthday),g=f=>{f<o?($i(),a(o)):a(f),localStorage.setItem("PowerPulsDate",f)};return C.useEffect(()=>{s(D.getDiary("?date="+ki(r)))},[s,r,c.length,h.length]),e.jsxs(mi,{children:[e.jsx(F,{}),e.jsxs(wi,{children:[e.jsx(hi,{children:"Diary"}),e.jsxs(gi,{children:[e.jsx(fi,{children:e.jsx(I,{currentDate:r,handlerDate:g,birthdayDate:o,textSize:18,textWeight:"bold",textHeight:20,sizeArrow:18,iconColor:l.secondaryOrange})}),e.jsx(ui,{children:e.jsx(I,{currentDate:r,handlerDate:g,textSize:24,textWeight:"bold",textHeight:32,sizeArrow:18,iconColor:l.secondaryOrange})})]})]}),e.jsxs(Ti,{children:[e.jsxs(ji,{children:[e.jsx(pi,{}),e.jsxs(yi,{children:[e.jsx(Di,{size:24}),e.jsx(bi,{children:"Record all your meals in a calorie diary every day. This will help me be aware of my nutrition and make me responsible for my choices."})]})]}),e.jsxs(vi,{children:[e.jsx(ke,{}),e.jsx(ti,{})]})]})]})},Di=({size:i})=>e.jsx("div",{style:{width:`${i}px`,height:`${i}px`},children:e.jsx(Ci,{width:i,height:i,className:"orange",children:e.jsx("use",{href:`${x}#icon-exclamation-mark`})})});export{Di as IconInfo,Oi as default};
